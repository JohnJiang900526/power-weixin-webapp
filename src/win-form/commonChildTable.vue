  ...
  <div class="chile-table-unit">
    ...
    <div class="chile-table-lists-form" :style="{'transform': 'translate3d(' + this.offset + '%, 0, 0)'}">
      ...
      <div class="footer-actions">
        <div @click="saveFromData" v-if="formState !== 'view'" class="action-item">保存</div>
...
import { removeList, organizeParams, getTableType, checkChildTableIsAdded, setChildTableData } from 'common/js/Util.js'
