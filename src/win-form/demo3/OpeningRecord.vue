<template>
  <div ref="OpeningRecord" class="chile-table-unit">
        ...
        <ul class="child-table-lists">
          ...
          <li v-if="tableLists.length"
            ...
            <form-list ref="formListUnit"
              ...
              :title="item.UnitName"
              :left="item.IsBid || '暂无'"
              :center="item.BidPrice + ''"
              :right="item.Remark || '暂无'"
              :tagShow="tagShow"
    ...
    <div class="chile-table-lists-form" :style="{'transform': 'translate3d(' + this.offset + '%, 0, 0)'}">
      <form class="input-textarea-group">
        <div class="input-row">
          <label class="label-text">竞标单位名称</label>
          <input v-model="currentItem.UnitName" type="text" class="input" placeholder="输入偏差项">
        </div>
        <div class="input-row">
          <label class="label-text">是否中标</label>
          <input v-model="currentItem.IsBid" type="text" class="input" placeholder="输入当前情况说明">
        </div>
        <div class="input-row">
          <label class="label-text">中标价格</label>
          <input v-model="currentItem.BidPrice" type="text" class="input" placeholder="输入原情况说明">
        </div>
        <div class="input-row">
          <label class="label-text">备注</label>
          <input v-model="currentItem.Remark" type="text" class="input" placeholder="输入原情况说明">
        </div>
      </form>
