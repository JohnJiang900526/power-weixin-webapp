<template>
  <div ref="RiskAssessment" class="chile-table-unit">
    ...
    <div class="chile-table-lists-form" :style="{'transform': 'translate3d(' + this.offset + '%, 0, 0)'}">
      <form class="input-textarea-group">
        <div class="input-row">
          <label class="label-text">风险分类</label>
          <input v-model="currentItem.RiskType" type="text" class="input" placeholder="输入风险分类">
        </div>
        <div class="input-row">
          <label class="label-text">风险评估</label>
          <input v-model="currentItem.RiskContent" type="text" class="input" placeholder="输入风险评估">
        </div>
      </form>
